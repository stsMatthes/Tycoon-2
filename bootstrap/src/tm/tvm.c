...
/*
  ...
  $File: //depot/tycoon2/stsmain/bootstrap/src/tm/tvm.c $ $Revision: #4 $ $Date: 2003/10/02 $  Andreas Gawecki, Marc Weikard
...
divisionbyzero:
		...
		*sp = pResult;
		...
		RAISE_TypeError(pArgument, tyc_ClassId_Int);
	      ...
	      BLABEL(tvm_Builtin_X_TL2Debugger__fetchStoppedThread):
		{
		tyc_Thread *pResult;
