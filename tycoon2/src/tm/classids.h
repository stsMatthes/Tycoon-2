...
/*
  ...
  $File: //depot/tycoon2/stsmain/tycoon2/src/tm/classids.h $ $Revision: #8 $ $Date: 2003/10/10 $ Marc Weikard
...
*/
  ...
  TYC_CLASSID(TL2, Selector,            Struct, "oiio")

  TYC_CLASSID(TL2 , Method,              Struct, "ooooooiiioi")
  TYC_CLASSID(TL2 , CompiledMethod,      Struct, "ooooooiiioiooioooiio")
  TYC_CLASSID(TL2 , BuiltinMethod,       Struct, "ooooooiiioiooioooiioii")
  TYC_CLASSID(TL2 , ExternalMethod,      Struct, "ooooooiiioiooooii")
  TYC_CLASSID(TL2 , SlotMethod,          Struct, "ooooooiiioioi")  
  TYC_CLASSID(TL2 , SlotAccessMethod,    Struct, "ooooooiiioioi")  
  TYC_CLASSID(TL2 , SlotUpdateMethod,    Struct, "ooooooiiioioi") 
  TYC_CLASSID(TL2 , PoolMethod,          Struct, "ooooooiiioio")  
  TYC_CLASSID(TL2 , PoolAccessMethod,    Struct, "ooooooiiioio")  
  TYC_CLASSID(TL2 , PoolUpdateMethod,    Struct, "ooooooiiioio")  
  TYC_CLASSID(TL2 , CSlotAccessMethod,   Struct, "ooooooiiioioiC") 
  TYC_CLASSID(TL2 , CSlotUpdateMethod,   Struct, "ooooooiiioioiC")
  TYC_CLASSID(TL2 , SlotReferenceMethod, Struct, "ooooooiiioioi")  
  TYC_CLASSID(TL2 , SlotTakeFromMethod,  Struct, "ooooooiiioioi")  
  TYC_CLASSID(TL2 , SlotMoveToMethod,    Struct, "ooooooiiioioi") 
  TYC_CLASSID(TL2 , CSlotReferenceMethod,Struct, "ooooooiiioioiC")  
  TYC_CLASSID(TL2 , CSlotTakeFromMethod, Struct, "ooooooiiioioiC")  
  TYC_CLASSID(TL2 , CSlotMoveToMethod,   Struct, "ooooooiiioioiC") 
  TYC_CLASSID(TL2 , CompiledFun,         Struct, "ooooooiiioiooioooiiooi")
  TYC_CLASSID(BUILTIN, Function,            Array,  NULL)       
  TYC_CLASSID(TL2 , DeferredMethod,      Struct, "ooooooiiioi")
  TYC_CLASSID(TL2 , UnimplementedMethod, Struct, "ooooooiiioi")
  TYC_CLASSID(TL2 , ReorderMethod, 	 Struct, "ooooooiiioiioiiCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC")
