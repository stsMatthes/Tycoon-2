...
/*
  ...
  $File: //depot/tycoon2/stsmain/tycoon2/src/tm/classids.h $ $Revision: #9 $ $Date: 2003/10/21 $ Marc Weikard
...
*/
  ...
  TYC_CLASSID(TL2 , ReorderMethod, 	 Struct, "ooooooiiioiioioCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC")
