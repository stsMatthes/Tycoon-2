 ...
 */
/*
  tosMd5.c 1.0 final  16-OCT-1998  Andre Willomat
...
unsigned int tosMd5_contextSize(void)
{
  return sizeof(MD5_CTX);
}

void tosMd5_init(MD5_CTX *context)
{
  MD5Init(context);
}

void tosMd5_update(MD5_CTX       *context,
                   unsigned char *buffer,
                   unsigned int   offset,
                   unsigned int   n)
{
  MD5Update(context, buffer+offset, n);
}

void tosMd5_final(MD5_CTX *context, unsigned char signature[16])
{
